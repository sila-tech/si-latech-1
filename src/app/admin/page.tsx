                ...
                <div className="border-b border-slate-200 pb-4 mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-6 pt-3 border-t border-slate-200 text-left">
                        <div>
                            ...
                            <p className="text-sm font-bold text-slate-900">{selectedProject ? getProjectName(selectedProject) : 'N/A'}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm font-bold text-slate-900">{selectedProject ? getProjectLocation(selectedProject) : 'N/A'}</p>
                        </div>
                    </div>
                </div>
                ...
                <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden flex flex-col print-dialog-content">
                    ...
                    <CardFooter className="flex justify-between border-t pt-4 print:hidden">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button onClick={() => window.print()} className="bg-primary font-bold"><Download size={15} className="mr-1.5" /> Print Layout</Button>
                        </div>
                    </CardFooter>
                </DialogContent>
            </Dialog>
