    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold font-headline text-slate-900">Staff Management</h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card className="lg:col-span-1 border-slate-200">
                    <CardHeader>
                        ...
                        <CardDescription>Create an account for field staff and technicians.</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardContent>
                        {isLoading ? (
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {staff?.length === 0 ? (
                                        <TableRow><TableCell colSpan={4} className="text-center text-slate-500 py-8">No staff accounts found.</TableCell></TableRow>
                                    ) : (
                                        staff?.map(s => (
                                            <TableRow key={s.id}>
                                                <TableCell className="font-bold flex items-center gap-2">
                                                    <ShieldCheck size={14} className="text-primary" /> {s.name}
                                                </TableCell>
